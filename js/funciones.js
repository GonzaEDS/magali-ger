function completarDatos() {
  ...
  switch (true) {
    ...
    default:
      var permiso = confirm(
        `Hola ${nombre}, tienes permiso para viajar? Seleccione cancelar en caso negativo`
      )
      if (permiso) {
        console.log(
          `Hola ${nombre} ya que cuentas con el permiso para viajar puede acceder a la compra de pasaportes.`
        )
      } else {
  ...
  let precioNeto = parseFloat(prompt('Ingresar el precio neto de su pasaje: '))
